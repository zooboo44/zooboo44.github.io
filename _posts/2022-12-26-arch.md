...
- [AwesomeWM Install and config](https://github.com/zooboo44/boilerplates/tree/master/arch/awesomewm)
- [Hyprland Install and config](https://github.com/zooboo44/boilerplates/tree/master/arch/hyprland)
...
---
# Misc
- Find battery level (Alias put in [.bashrc](https://github.com/zooboo44/boilerplates/tree/master/arch/bash))
```
